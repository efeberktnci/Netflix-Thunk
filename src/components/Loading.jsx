...
const Loading = () => {
  return (
    <>
      <p style={{height: "300px" }} className="placeholder-glow col-md-6 d-flex flex-column align-items-center gap-4">
       ...
       <span style={{height: "300px"}} className="placeholder col-md-6 placeholder-lg placeholder-wave">
